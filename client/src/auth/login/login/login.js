...
const RenderLogin = ( { user, onSubmit, view, edit}) => {
    ...
    */
    ...
    return (
        ...
        <form onSubmit={handleSubmit} style={{display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', alignSelf: 'center', margin: '10vh 0px 12px 0px'}}>
        <Box
                sx={{
                    width: 800,
                    maxWidth: '100%',
        ...
        <div style = {{display: "flex", flexDirection: "row"}}>
            <p style = {{margin: "12px", color: "black"}}> not a member yet </p>
